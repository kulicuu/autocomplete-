...
var _user$project$Main$wsUrl = 'ws://localhost:5000';
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'ToggleStreaming') {
			var newModel = _elm_lang$core$Native_Utils.update(
				model,
				{streamTime: !model.streamTime});
			var msg = newModel.streamTime ? 'start' : 'stop';
			var cmd = A2(_elm_lang$websocket$WebSocket$send, _user$project$Main$wsUrl, msg);
...
var _user$project$Main$initModel = {streamTime: false, time: ''};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$initModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {streamTime: a, time: b};
	});
var _user$project$Main$Time = function (a) {
	return {ctor: 'Time', _0: a};
};
var _user$project$Main$decodeTime = function (message) {
	return _user$project$Main$Time(
		A2(
...
var _user$project$Main$subscriptions = function (model) {
	return model.streamTime ? A2(_elm_lang$websocket$WebSocket$listen, _user$project$Main$wsUrl, _user$project$Main$decodeTime) : _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$ToggleStreaming = {ctor: 'ToggleStreaming'};
var _user$project$Main$view = function (model) {
	var toggleLabel = model.streamTime ? 'Stop' : 'Start';
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ToggleStreaming),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(toggleLabel),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
